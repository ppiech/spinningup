...
if __name__ == '__main__':
    ...
    eg.add('goal_octaves', [3, 5, 7])
    eg.add('goal_discount_rate', [0.03, 0.1])
    eg.add('split_action_and_goal_models', [False], '')
    eg.add('finish_action_path_on_new_goal', [True, False], '')    
    eg.add('ac_kwargs:hidden_sizes', [(32, ), (32, 32), (64, 64)], 'hid')
    eg.add('ac_kwargs:activation', [tf.nn.relu], '')
    eg.add('inverse_kwargs:hidden_sizes', [(32, ), (32, 32), (64, 64)], 'hid')
